...
class Parte_10_5 {
  Future<void> createPDF_10_5(
      ...
      List<Map<String, String>> matpelDatos,
...
PdfFont font = PdfStandardFont(PdfFontFamily.helvetica, 20, style: PdfFontStyle.bold);
    ...
    page1.graphics.drawString('10-5', font, bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width, page1.getClientSize().height));
...
page2.graphics.drawString('Parte de emergencias', font ,bounds: Rect.fromLTWH(150, 70, page1.getClientSize().width,page1.getClientSize().height));
    page2.graphics.drawString('10-5', font, bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width, page1.getClientSize().height));
...
page3.graphics.drawString('Parte de emergencias', font ,bounds: Rect.fromLTWH(150, 70, page1.getClientSize().width,page1.getClientSize().height));
    page3.graphics.drawString('10-5', font, bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width, page1.getClientSize().height));
    ...
    page2.graphics.drawString('4.- Datos material peligroso',
      ...
      page2.graphics.drawString('Nombre MATPEL',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            0, 160, page2.getClientSize().width, page2.getClientSize().height));

     page2.graphics.drawString('Medida',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            150, 160, page2.getClientSize().width, page2.getClientSize().height));
    ...
    PdfGrid gridMATPEL = PdfGrid();
    _createGrid(gridMATPEL, 4);
     gridMATPEL.columns[0].width = 125;
     gridMATPEL.columns[1].width = 125;
     gridMATPEL.columns[2].width = 125;
     gridMATPEL.columns[3].width = 125;

    
    for (var _matpelDato in matpelDatos) {
      _addGridRows2(
          gridMATPEL,
          _matpelDato['MATPEL'] ?? '',
          _matpelDato['Unidad(Kg o Lt)'] ?? '',
          _matpelDato['Cantidad'] ?? '',
          _matpelDato['Detalles'] ?? '');
    }

    
    _drawGrid(page2, gridMATPEL, const Rect.fromLTWH(0, 180, 0, 0));
...
Future<void> _saveAndLaunchFile(List<int> bytes, String unidad, String fecha) async {
  ...
  try {
    ...
    final fileName = '10-5_${unidad}_$fecha.pdf';
