...
class Parte_10_1 {
  Future<void> createPDF_10_1(
    ...
    page1.graphics.drawString('Parte de emergencias', font,
        bounds: Rect.fromLTWH(150, 70, page1.getClientSize().width,
            page1.getClientSize().height));
    page1.graphics.drawString('10-1', font,
        bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width,
            page1.getClientSize().height));

    page2.graphics.drawString('Parte de emergencias', font,
        bounds: Rect.fromLTWH(150, 70, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString('10-1', font,
        bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width,
            page1.getClientSize().height));

    page3.graphics.drawString('Parte de emergencias', font,
        bounds: Rect.fromLTWH(150, 70, page1.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString('10-1', font,
        bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width,
            page1.getClientSize().height));
    ...
    _addGridRow(gridDl1, 'Tipo de vía', tvia ?? '');
    _drawGrid(page1, gridDl1, const Rect.fromLTWH(0, 300, 0, 0));

    page1.graphics.drawString(
        '3.- Datos del afectado', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
    ...
    _addGridRow(gridDp1, 'Tipo ocupante', tocupante ?? '');
    _drawGrid(page1, gridDp1, const Rect.fromLTWH(0, 420, 0, 0));

    page1.graphics.drawString(
        '4.- Datos del vehiculo', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            5, 580, page1.getClientSize().width, page1.getClientSize().height));

    PdfGrid gridV = PdfGrid();
    _createGrid(gridV, 2);
    gridV.columns[0].width = 150;
    gridV.columns[1].width = 350;
    _addGridRow(gridV, 'Tipo vehiculo:', tvehiculo);
    _addGridRow(gridV, 'Marca vehiculo:', mvehiculo);
    _addGridRow(gridV, 'Modelo vehiculo', modelovehiculo);
    _addGridRow(gridV, 'Patente vehiculo', pvehiculo);
    _addGridRow(gridV, 'Daños', dvehiculo ?? '');
    _drawGrid(page1, gridV, const Rect.fromLTWH(0, 600, 0, 0));

    page2.graphics.drawString(
        'Descripcion preliminar', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 110, page2.getClientSize().width, page2.getClientSize().height));
    ...
    _drawGrid(page2, griddp, const Rect.fromLTWH(0, 130, 0, 0));

    page2.graphics.drawString('5.- Ocupantes del vehiculo',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 180, page1.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Nombre', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            0, 195, page1.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Rut', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(200, 195, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Edad', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(300, 195, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Estado', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(400, 195, page1.getClientSize().width,
            page1.getClientSize().height));

    PdfGrid gridOcupantes = PdfGrid();
    _createGrid(gridOcupantes, 4);
    gridOcupantes.columns[0].width = 200;
    gridOcupantes.columns[1].width = 100;
    gridOcupantes.columns[2].width = 50;
    gridOcupantes.columns[3].width = 150;
    ...
    _drawGrid(page2, gridOcupantes, const Rect.fromLTWH(0, 210, 0, 0));

    page2.graphics.drawString('6.- Otros vehiculos afectados',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 310, page1.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Tipo V.', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            0, 325, page1.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Marca', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(80, 325, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Modelo', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(160, 325, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Patente', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(240, 325, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Rut C.', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(320, 325, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Nombre C.', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(410, 325, page1.getClientSize().width,
            page1.getClientSize().height));

    PdfGrid gridAfectados = PdfGrid();
    _createGrid(gridAfectados, 6);
    gridAfectados.columns[0].width = 80;
    gridAfectados.columns[1].width = 80;
    gridAfectados.columns[2].width = 80;
    gridAfectados.columns[3].width = 60;
    gridAfectados.columns[4].width = 90;
    gridAfectados.columns[5].width = 120;

    for (var vafectado in vafectados) {
      _addGridRows1(
          gridAfectados,
          vafectado['Tipo de vehiculo'] ?? '',
          vafectado['Marca'] ?? '',
          vafectado['Modelo'] ?? '',
          vafectado['Patente'] ?? '',
          vafectado['Rut conductor'] ?? '',
          vafectado['Nombre conductor'] ?? '');
    }

    _drawGrid(page2, gridAfectados, const Rect.fromLTWH(0, 340, 0, 0));

    page2.graphics.drawString('7.- Otros Ocupantes afectados',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 440, page1.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Nombre', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            0, 455, page1.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Rut', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(200, 455, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Edad', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(300, 455, page1.getClientSize().width,
            page1.getClientSize().height));
    page2.graphics.drawString(
        'Estado', PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(400, 455, page1.getClientSize().width,
            page1.getClientSize().height));
    ...
    for (var otroocupantes in otroocupante) {
      _addGridRows11(
          gridOtroocupantes,
          otroocupantes['Nombre'] ?? '',
          otroocupantes['Rut'] ?? '',
          otroocupantes['Edad'] ?? '',
          otroocupantes['Estado'] ?? '');
    }

    _drawGrid(page2, gridOtroocupantes, const Rect.fromLTWH(0, 470, 0, 0));

    page2.graphics.drawString(
        '8.- Material mayor', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 580, page2.getClientSize().width, page1.getClientSize().height));
    page2.graphics.drawString(
        'Unidad', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 600, page2.getClientSize().width, page1.getClientSize().height));
    page2.graphics.drawString(
        'Maquinista', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(130, 600, page2.getClientSize().width,
            page1.getClientSize().height));

    page2.graphics.drawString(
        'Obac', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(250, 600, page2.getClientSize().width,
            page1.getClientSize().height));

    page2.graphics.drawString(
        'Nro personal', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(380, 600, page2.getClientSize().width,
            page1.getClientSize().height));
    ...
    _drawGrid(page2, gridmaterialm, const Rect.fromLTWH(0, 620, 0, 0));

    page3.graphics.drawString('9.- bomberos accidentados',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 120, page1.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString(
        'Cia', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 140, page1.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString(
        'Nombre', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(50, 140, page1.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString(
        'Rut', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(170, 140, page1.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString(
        'Constancia', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(230, 140, page1.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString(
        'Comisaria', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(330, 140, page1.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString(
        'Detalles', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(430, 140, page1.getClientSize().width,
            page1.getClientSize().height));
    ...
    _drawGrid(page3, gridbaccidentados, const Rect.fromLTWH(0, 160, 0, 0));

    page3.graphics.drawString('10.- Otros servicios de emergencia en el lugar',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 250, page3.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString(
        'Servicios', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 270, page3.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString(
        'Unidad', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(100, 270, page3.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString(
        'A cargo', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(200, 270, page3.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString(
        'Nro personal', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(300, 270, page3.getClientSize().width,
            page1.getClientSize().height));
    page3.graphics.drawString(
        'Observaciones', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(400, 270, page3.getClientSize().width,
            page1.getClientSize().height));
    ...
    _drawGrid(page3, gridServicios, const Rect.fromLTWH(0, 290, 0, 0));

    page3.graphics.drawString(
        '11.- Asistencia:', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 400, page3.getClientSize().width, page3.getClientSize().height));
    page3.graphics.drawString(
        'Nombre', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 420, page3.getClientSize().width, page3.getClientSize().height));
    page3.graphics.drawString(
        'Nombre', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(280, 420, page3.getClientSize().width,
            page3.getClientSize().height));
    page3.graphics.drawString(
        'Rut', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(150, 420, page3.getClientSize().width,
            page3.getClientSize().height));
    page3.graphics.drawString(
        'Rut', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(430, 420, page3.getClientSize().width,
            page3.getClientSize().height));

    List<List<Map<String, String>>> dividirListaEnChunks(
        List<Map<String, String>> lista, int tamanoChunk) {
      List<List<Map<String, String>>> chunks = [];
      for (var i = 0; i < lista.length; i += tamanoChunk) {
        chunks.add(lista.sublist(i,
            i + tamanoChunk > lista.length ? lista.length : i + tamanoChunk));
      }
      return chunks;
    }

    List<List<Map<String, String>>> chunksAsistentes =
        dividirListaEnChunks(asistentes, 1);
  ...
  void _addGridRows11(PdfGrid grid, String cell1Value, String cell2Value,
  ...
  void _addGridRows12(PdfGrid grid, String cell1Value, String cell2Value,
      String cell3Value, String cell4Value) {
    PdfGridRow row = grid.rows.add();
    row.cells[0].value = cell1Value;
    row.cells[1].value = cell2Value;
  ...
  Future<void> _saveAndLaunchFile(
      List<int> bytes, String unidad, String fecha) async {
    await requestPermissions();

    try {
      final directory = await getExternalStorageDirectory();
      final path = directory?.path ?? '';
      final fileName = '10-1_${unidad}_$fecha.pdf';
