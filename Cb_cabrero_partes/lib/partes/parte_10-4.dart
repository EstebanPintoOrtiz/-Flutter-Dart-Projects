...
PdfFont font = PdfStandardFont(PdfFontFamily.helvetica, 20, style: PdfFontStyle.bold);
    ...
    page1.graphics.drawString('10-4', font, bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width, page1.getClientSize().height));
...
page2.graphics.drawString('Parte de emergencias', font ,bounds: Rect.fromLTWH(150, 70, page1.getClientSize().width,page1.getClientSize().height));
    page2.graphics.drawString('10-4', font, bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width, page1.getClientSize().height));
...
page3.graphics.drawString('Parte de emergencias', font ,bounds: Rect.fromLTWH(150, 70, page1.getClientSize().width,page1.getClientSize().height));
    page3.graphics.drawString('10-4', font, bounds: Rect.fromLTWH(230, 90, page1.getClientSize().width, page1.getClientSize().height));
    ...
    page1.graphics.drawString('4.- Datos del vehiculo',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
    ...
    _drawGrid(page2, griddp, const Rect.fromLTWH(0, 130, 0, 0));
     ...
     page2.graphics.drawString('Rut',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            200, 195, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Edad',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            300, 195, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Estado',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            400, 195, page1.getClientSize().width, page1.getClientSize().height));
    ...
    for (var ocupante in ocupantes) {
      _addGridRows12(gridOcupantes,ocupante['Nombre'] ?? '', ocupante['Rut'] ?? '',
          ocupante['Edad'] ?? '',ocupante['Estado'] ?? '');
    }
    ...
    page2.graphics.drawString('6.- Otros vehiculos afectados',
      ...
      page2.graphics.drawString('Tipo V.',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            0, 325, page1.getClientSize().width, page1.getClientSize().height));

     page2.graphics.drawString('Marca',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            80, 325, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Modelo',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            160, 325, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Patente',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            240, 325, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Rut C.',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            320, 325, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Nombre C.',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            410, 325, page1.getClientSize().width, page1.getClientSize().height));
    ...
    for (var vafectado in vafectados) {
      _addGridRows1(gridAfectados,vafectado['Tipo de vehiculo'] ?? '', vafectado['Marca'] ?? '',
          vafectado['Modelo'] ?? '',vafectado['Patente'] ?? '', vafectado['Rut conductor'] ?? '',vafectado['Nombre conductor'] ?? '');
    }
    ...
    page2.graphics.drawString('7.- Otros Ocupantes afectados',
     ...
     page2.graphics.drawString('Rut',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            200, 455, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Edad',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            300, 455, page1.getClientSize().width, page1.getClientSize().height));
      page2.graphics.drawString('Estado',
        PdfStandardFont(PdfFontFamily.helvetica, 13),
        bounds: Rect.fromLTWH(
            400, 455, page1.getClientSize().width, page1.getClientSize().height));
    ...
    page2.graphics.drawString(
        ...
        bounds: Rect.fromLTWH(
            130, 600, page2.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Obac', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            250, 600, page2.getClientSize().width, page1.getClientSize().height));

    page2.graphics.drawString(
        'Nro personal', PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            380, 600, page2.getClientSize().width, page1.getClientSize().height));
    ...
    page3.graphics.drawString('Cia',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            0, 140, page1.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('Nombre',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            50, 140, page1.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('Rut',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            170, 140, page1.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('Constancia',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            230, 140, page1.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('Comisaria',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            330, 140, page1.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('Detalles',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            430, 140, page1.getClientSize().width, page1.getClientSize().height));
    ...
    page3.graphics.drawString('Unidad',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            100, 270, page3.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('A cargo',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            200, 270, page3.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('Nro personal',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            300, 270, page3.getClientSize().width, page1.getClientSize().height));
    page3.graphics.drawString('Observaciones',
        PdfStandardFont(PdfFontFamily.helvetica, 15),
        bounds: Rect.fromLTWH(
            400, 270, page3.getClientSize().width, page1.getClientSize().height));
...
for (var i = 0; i < chunksAsistentes.length; i++) {
  ...
  void _addGridRows1(
      PdfGrid grid, String cell1Value, String cell2Value, String cell3Value,String cell4Value,String cell5Value,String cell6Value) {
    PdfGridRow row = grid.rows.add();
    row.cells[0].value = cell1Value;
    row.cells[1].value = cell2Value;
    row.cells[2].value = cell3Value;
  ...
  void _createGrid(PdfGrid grid, int columnsCount) {
    ...
    grid.style = PdfGridStyle(
      font: PdfStandardFont(PdfFontFamily.helvetica, 12),
      cellPadding: PdfPaddings(left: 5, right: 2, top: 2, bottom: 0),
    );
    grid.columns.add(count: columnsCount);
    for (int i = 0; i < columnsCount; i++) {
      grid.columns[i].width = 100;
...
Future<void> _saveAndLaunchFile(List<int> bytes, String unidad, String fecha) async {
  ...
  try {
    ...
    final fileName = '10-4_${unidad}_$fecha.pdf';
