import 'package:flutter_application_2/partes/parte_10-0.dart';
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class Formulario10_0 extends StatefulWidget {
  const Formulario10_0({Key? key}) : super(key: key);

  @override
  _Formulario10_0 createState() => _Formulario10_0();
}

class _Formulario10_0 extends State<Formulario10_0> {
  ...
  TextEditingController tconstruccion = TextEditingController();
  TextEditingController npisos = TextEditingController();
  ...
  List<String> porv = List.generate(11, (index) => '${index * 10}%');
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 20),
                    const Text(
                      '4-. Características del incendio',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight:
                            FontWeight.bold, 
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            margin: const EdgeInsets.symmetric(horizontal: 15),
                            child: TextFormField(
                              controller: tconstruccion,
                              decoration: const InputDecoration(
                                border: InputBorder.none,
                                hintText: "T. construcción",
                              ),
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              items: porv.map((String percentage) {
                    ...
                    const SizedBox(height: 20),
                    const Text(
                      'Seleccioné el tipo de estructura:',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight:
                            FontWeight.bold, 
                      ...
                      child: Column(
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            child: const Text('Agregar vivienda afectada'),
                          ),
                        ],
                      ),
                    ),
