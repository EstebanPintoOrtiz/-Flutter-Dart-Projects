import 'package:flutter_application_2/partes/parte_10-6.dart';
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class Formulario10_6 extends StatefulWidget {
  const Formulario10_6({Key? key}) : super(key: key);

  @override
  _Formulario10_6 createState() => _Formulario10_6();
}

class _Formulario10_6 extends State<Formulario10_6> {
  ...
  final List<Map<String, String>> _gasDatos = [];

  static final List<String> _contenedorOpciones = [
    'Cilindro de otro gas combustible',
    'Cilindro G.L.P',
    'Estanque de G.L.P de vehiculo',
    'Estanque de G.N.C de vehiculo',
    'Estanque de G.L.P, Aereo',
    'Estanque de G.L.P, Subterraneo',
    'Estanque de G.N.L',
    'Red de gas de ciudad',
    'Red de gas natural',
  ];
  static final List<String> _tipodeGas = [
    'Acetileno',
    'Amoníaco',
    'Gas de ciudad',
    'Gas descomposición orgánica ',
    'G.L.P',
    'G.N.C',
    'G.N.L',
    'Hidrogeno',
  ...
  static final List<String> _unidadGas = ['Kilos', 'Litros', 'Toneladas'];
  static final List<String> _empresaDistribuidora = [
    'Abastible',
    'Agas',
    'Codigas',
    'Energas',
  ...
  String? _seleccionGas;
  String? _seleccionContenedor;
  String? _seleccionUnidad;
  String? _seleccionEmpresa;
  ...
  final _controllers7 = {
    'Capacidad contenedor': TextEditingController(),
  };
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        border: InputBorder.none,
                        hintText: "Descripcion preliminar",
                      ),
                    ),
                  ),
                  const SizedBox(height: 20),
                  const Text(
                    '4-.Datos gas involucrado',
                    style: TextStyle(
                      fontSize: 16,
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: DropdownButtonFormField<String>(
                            decoration: const InputDecoration(
                              labelText: 'Selecciona el tipo de gas',
                        ...
                        Padding(
                          ...
                          child: DropdownButtonFormField<String>(
                            decoration: const InputDecoration(
                              labelText: 'Selecciona el tipo contenedor',
                              border: OutlineInputBorder(),
                            ),
                            value: _seleccionContenedor,
                            items: _contenedorOpciones
                                .map((e) => DropdownMenuItem<String>(
                                      value: e,
                                      child: Text(e),
                                    ))
                        ...
                        Padding(
                          ...
                          child: DropdownButtonFormField<String>(
                            decoration: const InputDecoration(
                              labelText: 'Selecciona unidad de medida',
                              border: OutlineInputBorder(),
                            ),
                            value: _seleccionUnidad,
                            items: _unidadGas
                                .map((e) => DropdownMenuItem<String>(
                                      value: e,
                                      child: Text(e),
                            ...
                            onChanged: (String? value) {
                              setState(() {
                                _seleccionUnidad = value;
                              });
                            },
                          ),
                        ),
                        for (var key in _controllers7.keys)
                          TextFormField(
                            controller: _controllers7[key],
                        ...
                        Padding(
                          ...
                          child: DropdownButtonFormField<String>(
                            decoration: const InputDecoration(
                              labelText: 'Selecciona empresa distribuidora',
                              border: OutlineInputBorder(),
                            ),
                            value: _seleccionEmpresa,
                            items: _empresaDistribuidora
                                .map((e) => DropdownMenuItem<String>(
                                      value: e,
                                      child: Text(e),
                                    ))
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (_controllers7.values.every((controller7) =>
                                    controller7.text.isNotEmpty) &&
                                _seleccionGas != null &&
                                _seleccionContenedor != null &&
                                _seleccionUnidad != null &&
                                _seleccionEmpresa != null) {
                              setState(() {
                                
                                _gasDatos.add({
                                  for (var entry in _controllers7.entries)
                                    entry.key: entry.value.text,
                                  'Gas': _seleccionGas!,
                                  'Contenedor': _seleccionContenedor!,
                                  'Unidad': _seleccionUnidad!,
                                  'Empresa': _seleccionEmpresa!,
                                });
                                for (var controller7 in _controllers7.values) {
                                  controller7.clear();
                                }
                                _seleccionGas = null;
                                _seleccionContenedor = null;
                              ...
                              ScaffoldMessenger.of(context)
                                ...
                                content: Text(
                                    'Por favor, completa todos los campos y selecciona una opción de MATPEL.'),
                              ));
                            }
                          },
                          child: const Text('Agregar gas involucrado'),
                        ),
                      ],
                    ),
                  ),
                  ...
                  if (_gasDatos.isNotEmpty)
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            const Text('Gas involucrado'),
                            IgnorePointer(
                              child: ListView.builder(
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                itemCount: _gasDatos.length,
                                itemBuilder: (context, index) {
                                  var datosgas = _gasDatos[index];
                                  return ListTile(
                                    title: Text(datosgas['Gas']!),
                                    subtitle: Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: [
                                        for (var entry in datosgas.entries)
                                          if (entry.key != 'Gas')
                                            Text(
